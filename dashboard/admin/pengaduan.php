...
$sql = "
    SELECT p.id, p.no_tiket, p.judul, p.status, p.created_at, p.updated_at,
           u.nama as pelapor, f.nama as fasilitas, u.role as role_pelapor
    FROM pengaduan p
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-exclamation-triangle me-2"></i> Kelola Pengaduan</h2>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted">(<?= $row['role_pelapor'] ?>)</small>
                                </td>
                            ...
                            <!-- Modal Ubah Status (Proses/Selesai) -->
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" 
                                                              name="catatan" 
                                                              rows="3" 
                                                              placeholder="Contoh: Teknisi sudah dikirim ke lokasi."></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <form method="POST" action="proses_status.php">
                                            ...
                                            <div class="modal-body">
                                                <div class="alert alert-warning">
                                                    ...
                                                    Pengaduan akan berstatus <strong>Ditolak</strong> dan tidak bisa diubah lagi.
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" 
                                                              name="catatan" 
                                                              rows="3" 
                                                              placeholder="Contoh: Foto tidak jelas / Lokasi tidak ditemukan." 
                                                              required></textarea>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                            ...
                            <!-- Modal Detail (sama seperti di riwayat.php) -->
                            <div class="modal fade" id="detailModal<?= $row['id'] ?>" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Diisi saat kita buat proses_status.php & lengkapi data -->
                                            <p class="text-center text-muted">Detail lengkap akan ditampilkan setelah pengaduan diproses.</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                                Tutup
...
<?php else: ?>
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <h4>Tidak ada pengaduan sesuai filter.</h4>
            <a href="?status=semua" class="btn btn-outline-primary">
